...
class InvoiceTypeOptionSerializer(serializers.ModelSerializer):
    class Meta:
        model = InvoiceTypeOption
        fields = ["id", "name", "code", "tax_rate", "sort_order", "status", "description", "created_at", "updated_at"]
        read_only_fields = ["id", "created_at", "updated_at"]
